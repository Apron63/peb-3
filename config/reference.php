 ...
 * }
 * @psalm-type TrsteelCkeditorConfig = array{
 *     class?: scalar|null, // Default: "Trsteel\\CkeditorBundle\\Form\\Type\\CkeditorType"
 *     autoload_ckeditor_js?: bool, // Default: true
 *     html_purifier?: array{
 *         config?: mixed, // The default html purifer config. See http://htmlpurifier.org/live/configdoc/plain.html for more information. // Default: []
 *     },
 *     transformers?: mixed, // Default data transformers for the submitted html. // Default: ["html_purifier"]
 *     toolbar?: mixed, // The default toolbar displayed on the editor. // Default: ["document","clipboard","editing","/","basicstyles","paragraph","links","/","insert","styles","tools"]
 *     toolbar_groups?: mixed, // Groups of icons in the editor. // Default: []
 *     startup_outline_blocks?: bool, // Whether to automaticaly enable the "show block" command when the editor loads. // Default: true
 *     ui_color?: scalar|null, // The base user interface color to be used by the editor. Must be a hex. // Default: null
 *     width?: scalar|null, // The editor UI outer width. Must be an integer or percentage. // Default: null
 *     height?: scalar|null, // The height of the editing area (that includes the editor content). // Default: null
 *     force_paste_as_plaintext?: scalar|null, // Force paste content as plain text. // Default: null
 *     language?: scalar|null, // The user interface language localization to use. // Default: null
 *     filebrowser_browse_url?: string|array{ // The location of an external file browser that should be launched when the Browse Server button is pressed.
 *         url?: scalar|null, // Default: null
 *         route?: scalar|null, // Default: null
 *         route_parameters?: mixed, // Default: []
 *     },
 *     filebrowser_upload_url?: string|array{ // The location of the script that handles file uploads.
 *         url?: scalar|null, // Default: null
 *         route?: scalar|null, // Default: null
 *         route_parameters?: mixed, // Default: []
 *     },
 *     filebrowser_image_browse_url?: string|array{ // The location of an external file browser that should be launched when the Browse Server button is pressed in the Image dialog window.
 *         url?: scalar|null, // Default: null
 *         route?: scalar|null, // Default: null
 *         route_parameters?: mixed, // Default: []
 *     },
 *     filebrowser_image_upload_url?: string|array{ // The location of the script that handles file uploads in the Image dialog window.
 *         url?: scalar|null, // Default: null
 *         route?: scalar|null, // Default: null
 *         route_parameters?: mixed, // Default: []
 *     },
 *     filebrowser_flash_browse_url?: string|array{ // The location of an external file browser that should be launched when the Browse Server button is pressed in the Flash dialog window.
 *         url?: scalar|null, // Default: null
 *         route?: scalar|null, // Default: null
 *         route_parameters?: mixed, // Default: []
 *     },
 *     filebrowser_flash_upload_url?: string|array{ // The location of the script that handles file uploads in the Flash dialog window.
 *         url?: scalar|null, // Default: null
 *         route?: scalar|null, // Default: null
 *         route_parameters?: mixed, // Default: []
 *     },
 *     skin?: scalar|null, // The skin to load. It may be the name of the skin folder inside the editor installation path, or the name and the path separated by a comma. // Default: null
 *     disable_native_spell_checker?: bool|null, // Disables the built-in spell checker if the browser provides one. // Default: null
 *     format_tags?: mixed, // An array of style names (by default tags) representing the style definition for each entry to be displayed in the Format combo in the toolbar. // Default: []
 *     base_path?: scalar|null, // The base URL path used to load ckeditor files from. // Default: "/bundles/trsteelckeditor/"
 *     base_href?: scalar|null, // The base href URL used to resolve relative and absolute URLs in the editor content. // Default: null
 *     body_class?: scalar|null, // Sets the class attribute to be used on the body element of the editing area. // Default: null
 *     contents_css?: list<scalar|null>,
 *     basic_entities?: scalar|null, // Whether to escape basic HTML entities in the document. // Default: null
 *     entities?: scalar|null, // Whether to use HTML entities in the output. // Default: null
 *     entities_latin?: scalar|null, // Whether to convert some Latin characters (Latin alphabet No. 1, ISO 8859-1) to HTML entities. // Default: null
 *     startup_mode?: scalar|null, // The mode to load at the editor startup. It depends on the plugins loaded. By default, the `wysiwyg` and `source` modes are available. // Default: null
 *     enter_mode?: scalar|null, // Sets the behavior of the Enter key. By default the `ENTER_P`, `ENTER_BR` and `ENTER_DIV` modes available. // Default: null
 *     custom_config?: scalar|null, // The path of the custom config.js to use for the editor setup. // Default: null
 *     remove_plugins?: mixed, // An array of plugins to remove. // Default: []
 *     external_plugins?: list<string|array{ // Default: []
 *         path: scalar|null,
 *         file?: scalar|null, // Default: "plugin.js"
 *     }>,
 *     templates_files?: mixed, // The list of templates definition files to load. // Default: []
 *     allowed_content?: scalar|null, // Allowed content rules. // Default: null
 *     extra_allowed_content?: scalar|null, // This option makes it possible to set additional allowed content rules for CKEDITOR.editor.filter. // Default: null
 *     templates_replace_content?: bool|null, // Whether the "Replace actual contents" checkbox is checked by default in the Templates dialog.. // Default: null
 * }
 * @psalm-type TcpdfConfig = array<mixed>
 ...
 *     trsteel_ckeditor?: TrsteelCkeditorConfig,
 *     tcpdf?: TcpdfConfig,
